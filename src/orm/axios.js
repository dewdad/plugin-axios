...
export default class Axios {
  constructor(http) {
    ...
    this.instance.interceptors.request.use(config => http.onRequest(config), error => http.onError(error))

    this.instance.interceptors.response.use(response => http.onResponse(response), error => http.onError(error))
